...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/neokura/XboxCompanion/main/install.sh) 0.2.0-alpha.3
```
...
- marks tagged pre-release versions such as `v0.2.0-alpha.3` as GitHub pre-releases
